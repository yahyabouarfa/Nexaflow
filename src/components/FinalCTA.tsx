    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-300">
          Your next workflow can run itself
        </p>
        <h2 className="mt-4 text-3xl font-black tracking-tight sm:text-5xl">
          Ready to automate your business?
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
          Start with one high-impact workflow, prove the value, then expand your AI
          operations layer across sales, support, and delivery.
        </p>
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <ButtonLink href="mailto:hello@nexaflow.ai">Book a Free Demo</ButtonLink>
